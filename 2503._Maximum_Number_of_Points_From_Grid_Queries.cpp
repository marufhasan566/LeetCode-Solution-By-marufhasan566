...
public:
    ...
    {
        set<int> sorted_queries(
            queries.begin(),
            queries.end()); // We need to only solve for unique query
        ...
        // Apply BFS for each query incrementally (since, a larger query will
        // always cover the cells of a smaller query)
