...
// https://www.youtube.com/watch?v=xLv7HkAfQiU&ab_channel=Techdose
// Just added. DUA
...
#define pii pair<int, int>
    ...
    void traverseComponent(int &bitwise_and, int curr, vector<bool> &visited,
...
public:
    ...
    {
        // Step-1: Keep components segregated using disjoint set and make
        // Adj-List
        vector<int> dsuf(n, -1);
